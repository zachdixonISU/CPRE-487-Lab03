...
HD_PWD='/home/zachdixo/cpre-487/lab03/CPRE-487-Lab03/cpre487-587-lab3-main/simple_interface/vivado/simple_interface/simple_interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log staged_mac_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source staged_mac_bd_wrapper.tcl
