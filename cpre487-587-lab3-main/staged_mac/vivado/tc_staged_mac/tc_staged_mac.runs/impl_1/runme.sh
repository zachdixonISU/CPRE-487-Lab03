...
HD_PWD='/home/zachdixo/cpre-487/lab03/CPRE-487-Lab03/cpre487-587-lab3-main/staged_mac/vivado/tc_staged_mac/tc_staged_mac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log staged_mac.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source staged_mac.tcl -notrace
